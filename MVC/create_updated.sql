...
CREATE TABLE vehiculo (
    ...
    CHECK (año >= 1900 AND año <= YEAR(CURRENT_DATE) + 1),
...
('AB123CD', 'Toyota', 'Corolla', 2022, 'Blanco', 25000, 15000, 'Vehículo en excelente estado, full equipo'),
('EF456GH', 'Honda', 'Civic', 2023, 'Negro', 28000, 8000, 'Nuevo, tecnología de punta'),
('IJ789KL', 'Nissan', 'Sentra', 2021, 'Rojo', 22000, 25000, 'Buen estado, mantención al día'),
('MN012OP', 'Hyundai', 'Tucson', 2022, 'Gris', 35000, 18000, 'SUV espaciosa, ideal para familia'),
('QR345ST', 'Kia', 'Sportage', 2023, 'Azul', 38000, 5000, 'SUV moderna, baja kilometraje'),
('UV678WX', 'Chevrolet', 'Spark', 2021, 'Verde', 15000, 30000, 'Económico, perfecto para ciudad');

-- Insertar arriendos de ejemplo
INSERT INTO arriendo (id_vehiculo, id_cliente, id_empleado, fecha_inicio, fecha_fin, costo_total, estado) VALUES 
(1, 1, 2, '2024-01-15', '2024-01-20', 125000, 'finalizado'),
(2, 2, 3, '2024-02-01', '2024-02-05', 112000, 'finalizado'),
(3, 3, 2, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 3 DAY), 66000, 'activo'),
(4, 4, 3, DATE_ADD(CURDATE(), INTERVAL 2 DAY), DATE_ADD(CURDATE(), INTERVAL 7 DAY), 175000, 'activo');
