...
from validador_formatos import validar_run, validar_nombre, validar_password, validar_cargo, validar_direccion, validar_telefono, validar_patente, validar_año, validar_precio, validar_estado_vehiculo, validar_fecha
import logging
